            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text text-center">
                        ...
                        <h1 style="color:white ; font-size: 50px; font-family: 'Montserrat',sans-serif; padding: 20px; "> Kontak Kami </h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>Jalan Cemara Komplek Perkantoran Pemda Tulang Bawang, Menggala</h3>
                            </div>
                        </div>
                        <div class="media contact-info">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>tulangbawangkab@site.com</h3>
                            </div>
                        </div>
                    </div>
                </div>
