                    ...
                    <div class="row">
                        <div class="col-lg-11 offset-lg-1">
                            <div class="story_info">
                                <div class="row">
                                    <div class="col-lg-9">
                                        <p>WebGIS merupakan aplikasi Geographic Information System (GIS) yang dapat diakses secara online melalui internet/web. Webgis adalah aplikasi GIS digunakan sebagai media komunikasi yang berfungsi mendistribusikan, mempublikasikan, mengintegrasikan, mengkomunikasikan dan menyediakan informasi dalam bentuk teks, peta dijital serta menjalankan fungsi-fungsi analisis dan query yang terkait dengan GIS melalui jaringan internet.</p>
                                <p>Webgis dapat digunakan diperangkat manapun seperti Android, Iphone, dan Desktop secara online.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
