...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'sidiriomunir@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Netizen'; // Isikan dengan nama pengirim
    protected $password = '*SidiRioMunir#'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        ...
        $mail->AddEmbeddedImage('assets/img/logo.png', 'logo_mynotescode', 'logo.png'); // Aktifkan jika ingin menampilkan gambar dalam email
